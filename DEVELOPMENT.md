...
```
|__bundles/
   |__ngx-fit-text.umd.js
   |__ngx-fit-text.umd.js.map
   |__ngx-fit-text.umd.min.js
   |__ngx-fit-text.bundle.min.js.map
|__index.d.ts
|__package.json
|__README.md
|__*.d.ts
|__ngx-fit-text.d.ts
|__ngx-fit-text.module.d.ts
|__ngx-fit-text.es5.js
|__ngx-fit-text.es5.js.map
|__ngx-fit-text.js
|__ngx-fit-text.js.map
|__ngx-fit-text.metadata.json
```
